...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    <head>
        ...
        <title>FMC Abuja E-intern</title>
        ...
        <div class="bg-white">
            ...
            <header x-data="{ open: false }" @keydown.window.escape="open = false" class="absolute inset-x-0 top-0 z-50">
              <nav class="flex items-center justify-between p-6 lg:px-8" aria-label="Global">
                ...
                <div class="flex lg:hidden">
                  <button type="button" class="-m-2.5 inline-flex items-center justify-center rounded-md p-2.5 text-gray-400" @click="open = true">
          ...
          <path stroke-linecap="round" stroke-linejoin="round" d="M18 12H6"></path>
                        ...
                        <dd class="mt-2 pr-12" id="faq-1" x-show="open">
                          <p class="text-base leading-7 text-gray-600">You boil the hell out of it. Lorem ipsum dolor sit amet consectetur adipisicing elit. Magnam aut tempora vitae odio inventore fuga aliquam nostrum quod porro. Delectus quia facere id sequi expedita natus.</p>
                        </dd>
                      </div>
                    <div x-data="{ open: false }" class="pt-6">
                        <dt>
          ...
          <path stroke-linecap="round" stroke-linejoin="round" d="M18 12H6"></path>
                        ...
                        <dd class="mt-2 pr-12" id="faq-2" x-show="open">
                          <p class="text-base leading-7 text-gray-600">Nobody knows. Lorem ipsum dolor sit amet consectetur adipisicing elit. Culpa, voluptas ipsa quia excepturi, quibusdam natus exercitationem sapiente tempore labore voluptatem.</p>
                        </dd>
                      </div>
                    <div x-data="{ open: false }" class="pt-6">
                        <dt>
          ...
          <path stroke-linecap="round" stroke-linejoin="round" d="M18 12H6"></path>
                        ...
                        <dd class="mt-2 pr-12" id="faq-4" x-show="open">
                          <p class="text-base leading-7 text-gray-600">Because the pee is silent. Lorem ipsum dolor sit amet, consectetur adipisicing elit. Ipsam, quas voluptatibus ex culpa ipsum, aspernatur blanditiis fugiat ullam magnam suscipit deserunt illum natus facilis atque vero consequatur! Quisquam, debitis error.</p>
                        </dd>
                      </div>
                    <div x-data="{ open: false }" class="pt-6">
                        <dt>
          ...
          <path stroke-linecap="round" stroke-linejoin="round" d="M18 12H6"></path>
                        ...
                        <dd class="mt-2 pr-12" id="faq-5" x-show="open">
                          <p class="text-base leading-7 text-gray-600">He couldn't see himself doing it. Lorem ipsum dolor sit, amet consectetur adipisicing elit. Eveniet perspiciatis officiis corrupti tenetur. Temporibus ut voluptatibus, perferendis sed unde rerum deserunt eius.</p>
                        </dd>
                      </div>
