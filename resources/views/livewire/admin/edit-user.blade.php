                ...
                <form wire:submit="create">
                    <div class="grid grid-cols-1 md:grid-cols-3 gap-4 px-4 py-2 items-center" >
                        <div class="flex flex-col justify-start">
                            <x-label for="surname" value="{{ __('Surname') }}" class="text-gray-900"><sup class="text-danger-600 font-medium">*</sup></x-label>
                            <x-input id="surname" class="block w-full px-4 mt-1" type="text" wire:model="surname" value="{{$record->surname}}" required autofocus autocomplete="surname" />
                        </div>
                        <div class="flex flex-col justify-start">
                            <x-label for="first_name" value="{{ __('First Name') }}" class="text-gray-900" />
                            <x-input id="first_name" class="block w-full px-4 mt-1" type="text" wire:model="first_name" required value="{{ $record->first_name}}"/>
                        </div>
                        <div class="flex flex-col justify-start">
                            <x-label for="middle_name" value="{{ __('Middle Name') }}" class="text-gray-900" />
                            <x-input id="middle_name" class="block w-full px-4 mt-1" type="text" wire:model="middle_name" value="{{ $record->middle_name}}"  />
                        </div>
                        <div class="flex flex-col justify-start">
